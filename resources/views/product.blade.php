<div class="product-row">
    <div class="row">
        ...
        <div class="col-md-5">
            ...
            <button class="btn btn-link" name="delete{{$product['id']}}" value="{{$product['id']}}">Retirer
            </button>
        </div>
        <div class="col-md-2 form-group">
            <label class="control-label" for="productQty{{$product['id']}}">Quantité</label>
            <input type="number" class="form-control" name="productQty[]"
                   id="productQty{{$product['id']}}" placeholder="Quantité" value="{{$product['qty']}}"
                   min="1" max="99" required>
        </div>
        <div class="col-md-1"><p>Prix: <span id="price{{$product['id']}}">{{$product['price']}} €</span>€</p>
        </div>
